...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NAV] = LAYOUT_tkl_ansi(
        ...
        _______, _______, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX, KC_CAPS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,
    ...
    [MOUSE] = LAYOUT_tkl_ansi(
        XXXXXXX, _______, _______, _______, MS_ACL2, XXXXXXX, XXXXXXX, G(S(KC_Z)), G(KC_V), G(KC_C), G(KC_X), G(KC_Z),
        _______, _______, _______, _______, MS_BTN1, XXXXXXX, XXXXXXX, XXXXXXX, MS_LEFT, MS_DOWN, MS_UP,   MS_RGHT,
    ...
    [NUM] = LAYOUT_tkl_ansi(
        ...
        KC_SCLN, KC_4,    KC_5,    KC_6,    KC_EQL,  XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, _______, _______,
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_BSLS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, KC_0,    KC_MINS, XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
    ),

    [SYM] = LAYOUT_tkl_ansi(
        KC_LCBR, KC_AMPR, KC_ASTR, KC_LPRN, KC_RCBR, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        KC_COLN, KC_DLR,  KC_PERC, KC_CIRC, KC_PLUS, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, _______, _______,
    ...
    [FUN] = LAYOUT_tkl_ansi(
        ...
        KC_F11,  KC_F4,   KC_F5,   KC_F6,   KC_SCRL, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, _______, _______,
...
const uint16_t PROGMEM mouse_toggle_combo[] = {KC_W, KC_E, KC_R, COMBO_END};
...
combo_t key_combos[] = {
    ...
    [MOUSE_TOGGLE_COMBO] = COMBO(mouse_toggle_combo, TG(MOUSE)),
};
